<template>
  <div class="grid place-items-center min-h-screen md:grid-cols-2 relative">
    <div class="flex items-center justify-center flex-col px-3" v-if="!isTermsVisible">
      ...
      <div class="text-center flex flex-col">
        ...
        />
        <span class="text-sm font-semibold text-ivory-900 cursor-pointer" @click="handleShowTerms"
          >تفقد الشروط والأحكام</span
        >
      </div>
      <small
    ...
    <div v-else>
      <TermsAndConditions @onHideTerms="handleHideTerms" />
    </div>
